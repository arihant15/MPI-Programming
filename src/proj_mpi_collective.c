...
int main(int argc, char **argv)
{
  ...
  char* output = "mpi_collective_out_test1";
  ...
  MPI_Bcast(&(A[0][0]), N * N, mpi_complex, 0, MPI_COMM_WORLD);
  MPI_Bcast(&(B[0][0]), N * N, mpi_complex, 0, MPI_COMM_WORLD);
  ...
  // MPI_Bcast(&A1[0][0], N * N, mpi_complex, 0, MPI_COMM_WORLD);
  // MPI_Bcast(&B1[0][0], N * N, mpi_complex, 0, MPI_COMM_WORLD);
  // printf("\nStarting fft1d Row on A & B...");
  ...
  MPI_Bcast(&(C[0][0]), N * N, mpi_complex, 0, MPI_COMM_WORLD);
  ...
  // MPI_Bcast(&C1[0][0], N * N, mpi_complex, 0, MPI_COMM_WORLD);
  // printf("\nStarting fft1d Row on C...");
